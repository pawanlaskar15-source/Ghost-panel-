...
DEFAULT_MAX_ATTACK_TIME = 400  # CHANGED: Max 400 seconds
DEFAULT_COOLDOWN = 80
DEFAULT_MAX_CONCURRENT = 13  # CHANGED: Max 13 concurrent attacks
...
def get_group_limits(chat_id):
    try:
        ...
        if doc:
            return (
                doc.get("max_concurrent", 13),  # CHANGED: Default 13
...
def get_user_limits(user_id):
    ...
    if plan and has_valid_plan(user_id, send_expiry_msg=False):
        return (13,  # CHANGED: 13 for authorized users
